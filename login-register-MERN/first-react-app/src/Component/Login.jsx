		...
		<form className="mt-8 space-y-6" >
			...
			<div className="relative">
				<div className="absolute right-0 mt-4"><svg xmlns="http://www.w3.org/2000/svg"
						...
						<path strokeLinecap="round" strokeinejoin="round" strokeWidth="2"
							d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
					</svg>
                </div>
				<label className="text-sm font-bold text-gray-700 tracking-wide">Email</label>
				<input name='email' value={user.email} className=" w-full text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" onChange={handleChanged} placeholder="mail@gmail.com" />
            </div>
			<div className="mt-8 content-center">
				<label className="text-sm font-bold text-gray-700 tracking-wide">
					Password
				</label>
				<input name='password' value={user.password} className="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" onChange={handleChanged} placeholder="Enter your password" />
            </div>
			...
			<p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
				...
				<a  className="text-indigo-500 hover:text-yellow-800 hover:underline cursor-pointer transition ease-in duration-300" onClick={()=>navigate('/register', { replace: true })}>Register here</a>
			</p>
		</form>
	</div>
</div>
